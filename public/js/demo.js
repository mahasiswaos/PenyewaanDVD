...
//
    ...
    var demo_themes = [
        {name: 'default', title: 'Default', img: getBaseURL() + 'img/themes/default.png'},
        {name: 'asphalt', title: 'Asphalt', img: getBaseURL() +  'img/themes/asphalt.png'},
        {name: 'purple-hills', title: 'Purple Hills', img: getBaseURL() + 'img/themes/purple-hills.png'},
        {name: 'adminflare', title: 'Adminflare', img: getBaseURL() + 'img/themes/adminflare.png'},
        {name: 'dust', title: 'Dust', img: getBaseURL() + 'img/themes/dust.png'},
        {name: 'frost', title: 'Frost', img: getBaseURL() + 'img/themes/frost.png'},
        {name: 'fresh', title: 'Fresh', img: getBaseURL() + 'img/themes/fresh.png'},
        {name: 'silver', title: 'Silver', img: getBaseURL() + 'img/themes/silver.png'},
        {name: 'clean', title: 'Clean', img: getBaseURL() + 'img/themes/clean.png'},
        {name: 'white', title: 'White', img: getBaseURL() + 'img/themes/white.png'}
    ];
